...
export async function GET(request: Request) {
  ...
  const results = [
    ...
    ...(appointmentsRes.data || []).map(a => ({
      ...
      id: a.id,
      title: ({ fiscal: 'Fiscal', labor: 'Laboral', accounting: 'Comptable', income_tax: 'Renda', freelance: 'Autònoms', companies: 'Societats', internal_meeting: 'Reunió interna', client_query: 'Consulta client', documentation: 'Documentació', other: 'Altre' }[a.topic] || a.topic),
