                      ...
                      <div key={closure.id} className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${closure.deducts_vacation ? 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400' : 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400'}`}>
