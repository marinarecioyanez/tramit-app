...
export function SettingsClient({ settings, holidays, closures }: SettingsClientProps) {
  ...
  async function handleSave() {
    ...
    try {
      ...
      setError('Error desant la configuració. Torna-ho a intentar.')
    } finally {
      setSaving(false)
    }
  }
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-muted-foreground">Idioma per defecte de la interfície</p>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="w-24"
                  />
                  <p className="text-xs text-muted-foreground">Dies laborables de vacances per treballador</p>
                </div>
              ...
              <div className="border-t pt-4 space-y-4">
                <h3 className="text-sm font-semibold">Límit de treballadors simultanis de vacances</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      className="w-24"
                    />
                    <p className="text-xs text-muted-foreground">Màxim de persones alhora de vacances el 2026</p>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      className="w-24"
                    />
                    <p className="text-xs text-muted-foreground">Màxim de persones alhora de vacances des de 2027</p>
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground">
              Les cites fora d&apos;aquest horari requeriran confirmació manual de l&apos;admin.
            </p>
          </CardContent>
        </Card>
      )}
        ...
        <Card>
          ...
          <CardContent>
                    ...
                    <div key={holiday.id} className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                      <div className="flex items-center gap-3">
                        <div className="text-center bg-tramit-blue text-white rounded-lg p-2 min-w-[48px]">
                          <div className="text-xs font-medium">{monthNames[date.getMonth()]}</div>
            ...
            <p className="text-xs text-muted-foreground mt-4">
              Per afegir o modificar festius, contacta amb el suport tècnic.
            </p>
          </CardContent>
        </Card>
      )}
